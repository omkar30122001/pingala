...
\end{lstlisting}
\begin{figure}[!htp]
	\includegraphics[width=\columnwidth]{/home/ubuntu/Desktop/Pingala Assignment/2.2.pdf}
	\caption{Plot of $x(n)$}
	\label{fig:xn}
\end{figure}
\item 		Find $X^{+}(z)$. \\
...
\end{lstlisting}
\begin{figure}[!htp]
	\includegraphics[width=\columnwidth]{/home/ubuntu/Desktop/Pingala Assignment/2.5.pdf}
	\caption{Plot of $y(n)$}
	\label{fig:yn}
\end{figure}
\item Find $Y^{+}(z)$. \\
